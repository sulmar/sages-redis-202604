...
var jsonPlaceholderUrl = builder.Configuration["JsonPlaceholder:Url"]
    ?? throw new InvalidOperationException("Missing configuration: JsonPlaceholder:Url");
builder.Services.AddScoped(_ => new HttpClient { BaseAddress = new Uri(jsonPlaceholderUrl) });
